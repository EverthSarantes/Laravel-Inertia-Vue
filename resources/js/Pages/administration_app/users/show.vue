...
<template>
    <dashboard :appName="'administration_app'">
                ...
                <form class="space-y-4 p-3 shadow rounded" method="POST" autocomplete="off" @submit.prevent="submitUpdateForm">
                    <div class="grid grid-cols-12 gap-4 pt-3">
                        ...
                        <div class="md:col-span-6 col-span-12">
                            ...
                            <input type="password" name="password" id="password" class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-100 disabled:text-gray-500 dark:disabled:bg-gray-800/50 dark:disabled:text-gray-500 cursor-not-allowed transition-colors" v-model="updateForm.password">
                        </div>
                        <div class="md:col-span-6 col-span-12">
                            <label for="can_login" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Puede Iniciar Sesión</label>
                            <select name="can_login" id="can_login" class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-100 disabled:text-gray-500 dark:disabled:bg-gray-800/50 dark:disabled:text-gray-500 cursor-not-allowed transition-colors" v-model="updateForm.can_login">
        ...
        <div class="container mx-auto px-4 mt-8">
            <Tabs :tabs="[
            ...
            ]" storageKey="user-management-tabs">
                <template #modules>
                    <div class="w-full mt-2">
                        <div class="flex flex-col sm:flex-row justify-between items-center mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">
                            <h5 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2 sm:mb-0">Módulos a los que posee acceso el Usuario</h5>
                        ...
                        <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm mt-4">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" id="modules_table">
                                ...
                                <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                                    <tr v-for="userModule in user.user_module" :key="userModule.id" class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <div class="flex gap-2">
                                                ...
                                                <DeleteButton :url="route('users.deleteModule', {userModule: userModule.id, user: userModule.user_id})" :deleteModal="deleteModal"/>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                ...
                <template #filters>
                    <div class="w-full mt-2">
                        <div class="flex flex-col sm:flex-row justify-between items-center mb-4 pb-2 border-b border-gray-200 dark:border-gray-700">
                            <h5 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2 sm:mb-0">Filtros de Información del Usuario</h5>
                            <button type="button" class="inline-flex items-center justify-center px-3 py-2 bg-blue-600 hover:bg-blue-700 dark:bg-blue-700 dark:hover:bg-blue-600 text-white rounded-md shadow-sm transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
                        ...
                        <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm mt-4">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" id="filters_table">
                                ...
                                <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                                    <tr v-for="userModelFilter in user.user_model_filters" :key="userModelFilter.id" class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <div class="flex gap-2">
                                                <DeleteButton :url="route('users.removeUserModelFilter', {userModelFilter: userModelFilter.id, user: user.id})" :delete-modal="deleteModal"/>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                ...
                <div class="w-full">
                    <div class="grid grid-cols-12 gap-4 p-4">
                        <div class="md:col-span-6 col-span-12">
                            ...
                            <select name="model" id="model"  v-model="selected_filter"
                                class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-100 disabled:text-gray-500 dark:disabled:bg-gray-800/50 dark:disabled:text-gray-500 transition-colors">
                    ...
                    <div class="grid grid-cols-12 gap-4 p-4" v-if="selected_filter_type == 'simple'">
                        ...
                        <div class="md:col-span-4 col-span-12 mb-2" v-if="selected_filter_field_data">
                            <label for="filter_value" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Valor</label>
                            <select v-if="selected_filter_field_data && selected_filter_field_data.type == 'static_select'" class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-100 disabled:text-gray-500 dark:disabled:bg-gray-800/50 dark:disabled:text-gray-500 transition-colors" id="filter_value" name="filter_value">
                            ...
                            <input v-else-if="selected_filter_field_data && selected_filter_field_data.type === 'open'"  type="text" class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-100 disabled:text-gray-500 dark:disabled:bg-gray-800/50 dark:disabled:text-gray-500 transition-colors" id="filter_value" name="filter_value"/>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-12 gap-4 p-4" v-if="selected_filter_type == 'relations'">
                        ...
                        <div class="md:col-span-4 col-span-12 mb-2" v-if="selected_relation">
                            <label for="filter_field" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Campo del Filtro</label>
                        ...
                        <div class="md:col-span-4 col-span-12 mb-2" v-if="selected_relation">
                            <label for="filter_operator" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Operador</label>
                            <select name="filter_operator" id="filter_operator" class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-10０ disabled:text-gray-5００ dark:disabled:bg-gray-8００/5０ dark:disabled:text-gray-5００ transition-colors">
                                <option :value="null" selected>Seleccione un campo</option>
                    ...
                    <div class="grid grid-cols-12 gap-4 p-4" v-if="selected_filter_type == 'functions'">
                        <div class="col-span-12">
                            ...
                            <select name="filter_relation" id="filter_relation" class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-10０ disabled:text-gray-5００ dark:disabled:bg-gray-8００/5０ dark:disabled:text-gray-5００ transition-colors" @input="setSelectedFunction">
                                <option :value="null" selected>Seleccione un campo</option>
                        ...
                        <div class="col-span-12 mt-3" v-if="selected_function">
                            ...
                            <input class="block w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-gray-100 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm disabled:bg-gray-10０ disabled:text-gray-5００ dark:disabled:bg-gray-8００/5０ dark:disabled:text-gray-5００ transition-colors" id="filter_value" name="filter_value"  v-bind="selected_function.field.attrs"/>
                        </div>
                    </div>
                </div>
            </form>
