                    ...
                    <form class="card p-3 mt-2" method="POST" autocomplete="off" @submit.prevent="submitUpdateForm">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                ...
                                <input type="text" name="description" id="description" class="form-control" v-model="updateForm.description">
                            </div>
        ...
        <div class="tab-content container" id="pills-tabContent">
                ...
                <div class="row">
                    <div class="col-lg-12 mt-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5>Módulos a los que posee acceso la Plantilla de Usuario</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover m-0" id="modules_table">
                                ...
                                <tbody>
                                    <tr v-for="userModule in user_template.modules" :key="userModule.id">
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                ...
                                                <button class="btn btn-danger btn-sm" type="button" @click="showDeleteModal(route('users.templates.deleteModule', {userTemplateModule: userModule.id, userTemplate: userModule.user_template_id}))">
            ...
            <div class="tab-pane fade text-primary" id="pills-model-filters" role="tabpanel" aria-labelledby="pills-model-filters-tab">
                <div class="row">
                    <div class="col-lg-12 mt-2">
                        <div class="d-flex justify-content-between align-items-center">
                            <h5>Filtros de Información de la plantilla de Usuario</h5>
